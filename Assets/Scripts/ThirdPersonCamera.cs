...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    //회전 각도
    private float horizontalAngle = 0f;         //위치 따라가기 부드러움
    private float verticalAngle = 0f;           // 회전 부드러움

    //움직임 용 변수
    private Vector3 currentVelocity;         //SmoothDamp용 속도
    ...
    void UpdateCameraSmooth()           //카메라 목표 위치계산 함수
    {
        //1. 목표 위치 계산
